...
heading = Label(root, text="WELCOME TO THE MASTERMIND GAME BY JASON AND HOLDEN", font=("arial", 20, "bold"),
                fg="steelblue").pack()
...
printGuesses = Button(root, text="Print your guesses", width=30, height=5, bg="lightblue", command=do_it).place(x=250,
                                                                                                                y=300)
...
printGuesses = Button(root, text="Print your guesses", width=30, height=5, bg="lightblue", command=print_it).place(
    x=250, y=300)
...
label1 = Label(root, text="The computer generated code is " + str(generatedCode), font=("arial", 15, "bold"),
               fg="black").place(x=10, y=500)
...
feedback = Button(root, text="Get feedback", width=30, height=5, bg="lightblue", command=getFeedback1).place(x=250,
                                                                                                             y=400)
